...
(function () {
    ...
    async function waitForStreamingComplete() {
        ...
        const checkInterval = 800;  // Slower check to avoid interruption
        const stableThreshold = 6;  // More stable checks required
        ...
        try {
            while (Date.now() - startTime < maxWait) {
                ...
                const isStreaming = document.querySelector('[class*="loading"]') ||
                    ...
                    document.querySelector('.stop-btn'); // specific check
